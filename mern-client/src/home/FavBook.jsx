  ...
  return (
    <div className='px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between items-center gap-12'>
         ...
         <span className='text-blue-700'>Book Here!</span></h2>
          ...
          Whether you prefer the crisp feel of a hardcover, 
          the convenience of an e-book, or the immersive experience of an audiobook, BookNook Online has it all. Join our community of 
          book lovers and start your next adventure today!
          </p>
          {/* stats */}
